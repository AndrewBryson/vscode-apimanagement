...
/**
 * This is the external face of extension.bundle.js, the main bundle for the extension.
...
// Exports for tests
// The tests are not packaged with the bundle and therefore only have access to code exported from this file.
//
// The tests should import '../extension.bundle.ts'. At design-time they live in tests/ and so will pick up this file (extension.bundle.ts).
// At runtime the tests live in dist/tests and will therefore pick up the main bundle at dist/extension.bundle.js.
